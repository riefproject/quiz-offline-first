...
class LoginPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // Menghindari keyboard menutupi input
      resizeToAvoidBottomInset: true,
      body: Container(
        // Background gradient sesuai desain
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            stops: const [0.0, 0.4],
            colors: [
              colors.tertiary.withValues(alpha:0.15), // Warm tone di atas
              colors.surfaceLowest,              // Memudar ke putih/surface bawaan
            ],
          ),
        ),
        child: SafeArea(
